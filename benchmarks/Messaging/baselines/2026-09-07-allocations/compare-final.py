...
paths={'before':base/'77c20ea3-binaries/Foundatio.Messaging.Benchmarks.dll','after':pathlib.Path('/tmp/foundatio-allocations/e677cf9a-binaries/Foundatio.Messaging.Benchmarks.dll'),'masstransit':pathlib.Path('/tmp/foundatio-allocations/e677cf9a-binaries/Foundatio.Messaging.Benchmarks.dll')}
