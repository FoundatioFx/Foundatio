...
namespace Foundatio.SampleJob {
    public class JobCommandsServiceProvider : BootstrappedServiceProviderBase {
        public JobCommandsServiceProvider() { }
        public JobCommandsServiceProvider(ILoggerFactory loggerFactory) : base(loggerFactory) {}
