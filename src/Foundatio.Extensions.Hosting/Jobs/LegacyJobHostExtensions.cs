...
public static class LegacyJobHostExtensions
{
    ...
    /// <see cref="Foundatio.Extensions.Hosting.Jobs.JobHostExtensions.AddJobRuntimeService"/>, which materializes durable
    /// occurrences with retry, recovery, and dead-lettering. Routing this default API onto the durable scheduler is a
    /// planned follow-up.
    /// </remarks>
    ...
    /// <see cref="Foundatio.Extensions.Hosting.Jobs.JobHostExtensions.AddJobRuntimeService"/>) instead.
    /// </remarks>
