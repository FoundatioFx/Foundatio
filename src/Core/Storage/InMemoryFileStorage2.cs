...
namespace Foundatio.Storage {
    public class InMemoryFileStorage2 : IFileStorage2 {
        ...
        public InMemoryFileStorage2() : this(1024 * 1024 * 256, 100) {}

        public InMemoryFileStorage2(long maxFileSize, int maxFiles) {
