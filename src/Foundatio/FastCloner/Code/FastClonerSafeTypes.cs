...
internal static class FastClonerSafeTypes
{
    ...
    {
        return FastClonerCache.GetOrAddAnonymousTypeStatus(type, t => t.IsClass && t is { IsSealed: true, IsNotPublic: true } && t.IsDefined(typeof(CompilerGeneratedAttribute), false) && (t.Name.StartsWith("<>") || t.Name.StartsWith("VB$")) && t.Name.Contains("AnonymousType"));
    }
    ...
    private static readonly AhoCorasick safeTypePrefixes = new AhoCorasick([TypePrefixes.SystemRuntimeType, TypePrefixes.MicrosoftExtensions, "System.Threading.Tasks.Task`"]);
    ...
    private static bool CalculateHasStableHashSemantics(Type type)
    {
        ...
        MethodInfo? getHashCodeMethod = type.GetMethod("GetHashCode", BindingFlags.Public | BindingFlags.Instance, null, Type.EmptyTypes, null);
