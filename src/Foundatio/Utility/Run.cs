...
public static class Run
{
    ...
    {
        var resiliencePolicy = new ResiliencePolicy(timeProvider ?? TimeProvider.System, logger ?? NullLogger.Instance) { MaxAttempts = maxAttempts, RetryInterval = retryInterval };
